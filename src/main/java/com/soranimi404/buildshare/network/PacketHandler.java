...
public class PacketHandler {
    ...
    public static void register() {
        ...
        INSTANCE.registerMessage(
                id++,
                RequestPreviewPacket.class,
                RequestPreviewPacket::encode,
                RequestPreviewPacket::new,
                RequestPreviewPacket::handle
        );

        // 注册预览数据包
        INSTANCE.registerMessage(
                id++,
                PreviewDataPacket.class,
                PreviewDataPacket::encode,
                PreviewDataPacket::new,
                PreviewDataPacket::handle
        );

        // 注册清除预览包
        INSTANCE.registerMessage(
                id++,
                ClearPreviewPacket.class,
                ClearPreviewPacket::encode,
                ClearPreviewPacket::new,
                ClearPreviewPacket::handle
        );
    }
}